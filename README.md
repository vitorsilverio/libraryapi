...
### Locally
- Make sure you have Python 3.10+ installed. You may have to prefix `pip` and `uvicorn` commands with `python3.9 -m` if you have more than one Python interpreter.
